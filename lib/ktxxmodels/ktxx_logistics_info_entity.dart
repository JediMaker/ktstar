...
class LogisticsInfoDataExpressList
    with JsonConvert<LogisticsInfoDataExpressList> {
  String title;
  int type;
  String time;
  String desc;
...
class LogisticsInfoDataExpressListList
    with JsonConvert<LogisticsInfoDataExpressListList> {
  String time;
  String subdesc;
}

class LogisticsInfoDataExpressInfo
    with JsonConvert<LogisticsInfoDataExpressInfo> {
  String number;
  String name;
  String tel;
}
