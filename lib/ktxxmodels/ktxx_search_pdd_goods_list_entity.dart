...
class KeTaoFeaturedSearchPddGoodsListEntity with JsonConvert<KeTaoFeaturedSearchPddGoodsListEntity> {
	bool status;
...
class KeTaoFeaturedSearchPddGoodsListData with JsonConvert<KeTaoFeaturedSearchPddGoodsListData> {
	int total;
	int page;
...
class KeTaoFeaturedSearchPddGoodsListDataList with JsonConvert<KeTaoFeaturedSearchPddGoodsListDataList> {
	@JSONField(name: "g_id")
	int gId;
...
class KeTaoFeaturedSearchPddGoodsListDataListCoupons with JsonConvert<KeTaoFeaturedSearchPddGoodsListDataListCoupons> {
