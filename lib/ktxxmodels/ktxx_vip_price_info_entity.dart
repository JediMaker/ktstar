...
class VipPriceInfoDiamondIconDesc
    with JsonConvert<VipPriceInfoDiamondIconDesc> {
  String icon;
  String desc;
  String subdesc;
  String ssubdesc;
...
class VipPriceInfoDiamondMoneyList
    with JsonConvert<VipPriceInfoDiamondMoneyList> {
  String type;
  String desc;
  String price;
  bool flag;
