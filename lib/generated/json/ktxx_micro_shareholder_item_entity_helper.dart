...
microShareholderItemEntityFromJson(
    MicroShareholderItemEntity data, Map<String, dynamic> json) {
  ...
  if (json['estimate'] != null) {
    data.estimate =
        new MicroShareholderItemEstimate().fromJson(json['estimate']);
  }
  if (json['interests'] != null) {
    data.interests =
        new MicroShareholderItemInterests().fromJson(json['interests']);
  }
  return data;
}

Map<String, dynamic> microShareholderItemEntityToJson(
    MicroShareholderItemEntity entity) {
...
microShareholderItemEstimateFromJson(
    MicroShareholderItemEstimate data, Map<String, dynamic> json) {
...
Map<String, dynamic> microShareholderItemEstimateToJson(
    MicroShareholderItemEstimate entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
microShareholderItemInterestsFromJson(
    MicroShareholderItemInterests data, Map<String, dynamic> json) {
...
Map<String, dynamic> microShareholderItemInterestsToJson(
    MicroShareholderItemInterests entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
