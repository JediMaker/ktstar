...
microShareholderItemEntityFromJson(KeTaoFeaturedMicroShareholderItemEntity data, Map<String, dynamic> json) {
	...
	if (json['estimate'] != null) {
		data.estimate = new KeTaoFeaturedMicroShareholderItemEstimate().fromJson(json['estimate']);
	}
...
Map<String, dynamic> microShareholderItemEntityToJson(KeTaoFeaturedMicroShareholderItemEntity entity) {
...
microShareholderItemEstimateFromJson(KeTaoFeaturedMicroShareholderItemEstimate data, Map<String, dynamic> json) {
...
Map<String, dynamic> microShareholderItemEstimateToJson(KeTaoFeaturedMicroShareholderItemEstimate entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
microShareholderItemInterestsFromJson(KeTaoFeaturedMicroShareholderItemInterests data, Map<String, dynamic> json) {
...
Map<String, dynamic> microShareholderItemInterestsToJson(KeTaoFeaturedMicroShareholderItemInterests entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
