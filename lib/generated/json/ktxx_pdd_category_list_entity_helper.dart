...
pddCategoryListEntityFromJson(
    PddCategoryListEntity data, Map<String, dynamic> json) {
  if (json['status'] != null) {
...
pddCategoryListDataFromJson(
    PddCategoryListData data, Map<String, dynamic> json) {
  if (json['level'] != null) {
