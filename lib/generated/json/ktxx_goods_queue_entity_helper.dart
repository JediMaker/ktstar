...
goodsQueueDataFromJson(GoodsQueueData data, Map<String, dynamic> json) {
  ...
  if (json['signPackage'] != null) {
    data.signPackage =
        new GoodsQueueDataSignPackage().fromJson(json['signPackage']);
  }
  return data;
}
...
goodsQueueDataSignPackageFromJson(
    GoodsQueueDataSignPackage data, Map<String, dynamic> json) {
  if (json['url'] != null) {
...
Map<String, dynamic> goodsQueueDataSignPackageToJson(
    GoodsQueueDataSignPackage entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['url'] = entity.url;
  return data;
}

goodsQueueDataGoodsInfoFromJson(
    GoodsQueueDataGoodsInfo data, Map<String, dynamic> json) {
  if (json['g_name'] != null) {
...
Map<String, dynamic> goodsQueueDataGoodsInfoToJson(
    GoodsQueueDataGoodsInfo entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
goodsQueueDataUserInfoFromJson(
    GoodsQueueDataUserInfo data, Map<String, dynamic> json) {
  if (json['username'] != null) {
    data.username = json['username']?.toString();
  }
  if (json['avatar'] != null) {
...
Map<String, dynamic> goodsQueueDataUserInfoToJson(
    GoodsQueueDataUserInfo entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['username'] = entity.username;
  data['avatar'] = entity.avatar;
  data['power_num'] = entity.powerNum;
