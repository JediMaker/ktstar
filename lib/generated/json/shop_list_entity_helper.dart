...
shopListEntityFromJson(ShopListEntity data, Map<String, dynamic> json) {
  ...
  if (json['data'] != null) {
    data.data = new ShopListData().fromJson(json['data']);
  }
  return data;
}
...
shopListDataFromJson(ShopListData data, Map<String, dynamic> json) {
  if (json['list'] != null) {
    data.xList = new List<ShopListDataList>();
    (json['list'] as List).forEach((v) {
      data.xList.add(new ShopListDataList().fromJson(v));
    });
  }
  if (json['page'] != null) {
...
shopListDataListFromJson(ShopListDataList data, Map<String, dynamic> json) {
...
Map<String, dynamic> shopListDataListToJson(ShopListDataList entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
