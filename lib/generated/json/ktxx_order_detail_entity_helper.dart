...
orderDetailEntityFromJson(KeTaoFeaturedOrderDetailEntity data, Map<String, dynamic> json) {
	if (json['status'] != null) {
	...
	if (json['data'] != null) {
		try {
			data.data = new KeTaoFeaturedOrderDetailData().fromJson(json['data']);
		} catch (e) {
		}
	}
	return data;
...
Map<String, dynamic> orderDetailEntityToJson(KeTaoFeaturedOrderDetailEntity entity) {
...
orderDetailDataFromJson(KeTaoFeaturedOrderDetailData data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['goods_list'] != null) {
		data.goodsList = new List<KeTaoFeaturedOrderDetailDataGoodsList>();
		(json['goods_list'] as List).forEach((v) {
			data.goodsList.add(new KeTaoFeaturedOrderDetailDataGoodsList().fromJson(v));
		});
	}
...
Map<String, dynamic> orderDetailDataToJson(KeTaoFeaturedOrderDetailData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
orderDetailDataGoodsListFromJson(KeTaoFeaturedOrderDetailDataGoodsList data, Map<String, dynamic> json) {
...
Map<String, dynamic> orderDetailDataGoodsListToJson(KeTaoFeaturedOrderDetailDataGoodsList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
