...
categoryBeanEntityFromJson(KeTaoFeaturedCategoryBeanEntity data, Map<String, dynamic> json) {
	if (json['status'] != null) {
...
Map<String, dynamic> categoryBeanEntityToJson(KeTaoFeaturedCategoryBeanEntity entity) {
...
categoryBeanDataFromJson(KeTaoFeaturedCategoryBeanData data, Map<String, dynamic> json) {
...
Map<String, dynamic> categoryBeanDataToJson(KeTaoFeaturedCategoryBeanData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
