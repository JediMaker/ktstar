...
homeGoodsListGoodsListFromJson(HomeGoodsListGoodsList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> homeGoodsListGoodsListToJson(HomeGoodsListGoodsList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
