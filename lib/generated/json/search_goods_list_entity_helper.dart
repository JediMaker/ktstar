...
searchGoodsListDataFromJson(SearchGoodsListData data, Map<String, dynamic> json) {
	if (json['total'] != null) {
...
searchGoodsListDataListFromJson(SearchGoodsListDataList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> searchGoodsListDataListToJson(SearchGoodsListDataList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
