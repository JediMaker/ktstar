...
rechargeExtraEntityFromJson(
  ...
  if (json['s_rechage_list'] != null) {
    ...
    (json['s_rechage_list'] as List).forEach((v) {
      data.sRechageList.add(new RechargeExtraSRechageList().fromJson(v));
    });
  }
  if (json['ratio'] != null) {
...
Map<String, dynamic> rechargeExtraEntityToJson(RechargeExtraEntity entity) {
...
rechargeExtraRatioFromJson(RechargeExtraRatio data, Map<String, dynamic> json) {
  if (json['fast'] != null) {
...
Map<String, dynamic> rechargeExtraRatioToJson(RechargeExtraRatio entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
