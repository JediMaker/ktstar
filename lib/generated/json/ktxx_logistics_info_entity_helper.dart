...
logisticsInfoEntityFromJson(
    LogisticsInfoEntity data, Map<String, dynamic> json) {
  if (json['status'] != null) {
...
logisticsInfoDataFromJson(LogisticsInfoData data, Map<String, dynamic> json) {
  ...
  if (json['express_info'] != null) {
    data.expressInfo =
        new LogisticsInfoDataExpressInfo().fromJson(json['express_info']);
  }
  return data;
}
...
logisticsInfoDataExpressListFromJson(
    LogisticsInfoDataExpressList data, Map<String, dynamic> json) {
  if (json['title'] != null) {
...
Map<String, dynamic> logisticsInfoDataExpressListToJson(
    LogisticsInfoDataExpressList entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
logisticsInfoDataExpressListListFromJson(
    LogisticsInfoDataExpressListList data, Map<String, dynamic> json) {
  if (json['time'] != null) {
    data.time = json['time']?.toString();
  }
...
Map<String, dynamic> logisticsInfoDataExpressListListToJson(
    LogisticsInfoDataExpressListList entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['time'] = entity.time;
...
logisticsInfoDataExpressInfoFromJson(
    LogisticsInfoDataExpressInfo data, Map<String, dynamic> json) {
  if (json['number'] != null) {
...
Map<String, dynamic> logisticsInfoDataExpressInfoToJson(
    LogisticsInfoDataExpressInfo entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
