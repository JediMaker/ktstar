...
searchGoodsListEntityFromJson(KeTaoFeaturedSearchGoodsListEntity data, Map<String, dynamic> json) {
	if (json['status'] != null) {
...
Map<String, dynamic> searchGoodsListEntityToJson(KeTaoFeaturedSearchGoodsListEntity entity) {
...
searchGoodsListDataFromJson(KeTaoFeaturedSearchGoodsListData data, Map<String, dynamic> json) {
	if (json['total'] != null) {
...
Map<String, dynamic> searchGoodsListDataToJson(KeTaoFeaturedSearchGoodsListData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
searchGoodsListDataListFromJson(KeTaoFeaturedSearchGoodsListDataList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> searchGoodsListDataListToJson(KeTaoFeaturedSearchGoodsListDataList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
