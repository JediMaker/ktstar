...
pddGoodsInfoEntityFromJson(KeTaoFeaturedPddGoodsInfoEntity data, Map<String, dynamic> json) {
	if (json['status'] != null) {
	...
	if (json['data'] != null) {
		data.data = new KeTaoFeaturedPddGoodsInfoData().fromJson(json['data']);
	}
	return data;
}

Map<String, dynamic> pddGoodsInfoEntityToJson(KeTaoFeaturedPddGoodsInfoEntity entity) {
...
pddGoodsInfoDataFromJson(KeTaoFeaturedPddGoodsInfoData data, Map<String, dynamic> json) {
	if (json['g_id'] != null) {
	...
	if (json['coupons'] != null) {
		try {
			data.coupons = new KeTaoFeaturedPddGoodsInfoDataCoupons().fromJson(json['coupons']);
		} catch (e) {
		}
	}
	return data;
...
Map<String, dynamic> pddGoodsInfoDataToJson(KeTaoFeaturedPddGoodsInfoData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
pddGoodsInfoDataCouponsFromJson(KeTaoFeaturedPddGoodsInfoDataCoupons data, Map<String, dynamic> json) {
...
Map<String, dynamic> pddGoodsInfoDataCouponsToJson(KeTaoFeaturedPddGoodsInfoDataCoupons entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
