...
addressInfoEntityFromJson(KeTaoFeaturedAddressInfoEntity data, Map<String, dynamic> json) {
	if (json['status'] != null) {
	...
	if (json['data'] != null) {
		try {
			data.data = new KeTaoFeaturedAddressInfoData().fromJson(json['data']);
		} catch (e) {
		}
	}
	return data;
...
Map<String, dynamic> addressInfoEntityToJson(KeTaoFeaturedAddressInfoEntity entity) {
...
addressInfoDataFromJson(KeTaoFeaturedAddressInfoData data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> addressInfoDataToJson(KeTaoFeaturedAddressInfoData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
