...
phoneChargeListEntityFromJson(
    PhoneChargeListEntity data, Map<String, dynamic> json) {
  if (json['status'] != null) {
...
phoneChargeListDataFromJson(
    PhoneChargeListData data, Map<String, dynamic> json) {
  if (json['list'] != null) {
...
Map<String, dynamic> phoneChargeListDataToJson(
    PhoneChargeListData entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
phoneChargeListDataListFromJson(
    PhoneChargeListDataList data, Map<String, dynamic> json) {
  if (json['id'] != null) {
...
Map<String, dynamic> phoneChargeListDataListToJson(
    PhoneChargeListDataList entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['id'] = entity.id;
