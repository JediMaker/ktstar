...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case OrderDetailEntity:
			...
			return orderDetailDataGoodsListFromJson(data as OrderDetailDataGoodsList, json) as T;			case MicroShareholderItemEntity:
			...
			return microShareholderItemInterestsFromJson(data as MicroShareholderItemInterests, json) as T;			case PayCouponEntity:
			...
			return taskShareDataFooterImgFromJson(data as TaskShareDataFooterImg, json) as T;			case SearchGoodsListEntity:
			...
			return pddGoodsInfoDataCouponsFromJson(data as PddGoodsInfoDataCoupons, json) as T;			case OrderListEntity:
			...
			return pddGoodsListDataListCouponsFromJson(data as PddGoodsListDataListCoupons, json) as T;			case LoginEntity:
			return loginEntityFromJson(data as LoginEntity, json) as T;			case LoginData:
			return loginDataFromJson(data as LoginData, json) as T;			case CategoryBeanEntity:
			return categoryBeanEntityFromJson(data as CategoryBeanEntity, json) as T;			case CategoryBeanData:
			return categoryBeanDataFromJson(data as CategoryBeanData, json) as T;			case RechargeEntity:
			...
			return searchPddGoodsListDataListCouponsFromJson(data as SearchPddGoodsListDataListCoupons, json) as T;			case WechatPayinfoEntity:
			...
			return homeIconListIconListFromJson(data as HomeIconListIconList, json) as T;			case UserHolderProfitEntity:
			...
			return withdrawalListDataListFromJson(data as WithdrawalListDataList, json) as T;			case AddressListEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case OrderDetailEntity:
			...
			return orderDetailDataGoodsListToJson(data as OrderDetailDataGoodsList);			case MicroShareholderItemEntity:
			...
			return microShareholderItemInterestsToJson(data as MicroShareholderItemInterests);			case PayCouponEntity:
			...
			return taskShareDataFooterImgToJson(data as TaskShareDataFooterImg);			case SearchGoodsListEntity:
			...
			return pddGoodsInfoDataCouponsToJson(data as PddGoodsInfoDataCoupons);			case OrderListEntity:
			...
			return pddGoodsListDataListCouponsToJson(data as PddGoodsListDataListCoupons);			case LoginEntity:
			return loginEntityToJson(data as LoginEntity);			case LoginData:
			return loginDataToJson(data as LoginData);			case CategoryBeanEntity:
			return categoryBeanEntityToJson(data as CategoryBeanEntity);			case CategoryBeanData:
			return categoryBeanDataToJson(data as CategoryBeanData);			case RechargeEntity:
			...
			return searchPddGoodsListDataListCouponsToJson(data as SearchPddGoodsListDataListCoupons);			case WechatPayinfoEntity:
			...
			return homeIconListIconListToJson(data as HomeIconListIconList);			case UserHolderProfitEntity:
			...
			return withdrawalListDataListToJson(data as WithdrawalListDataList);			case AddressListEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'OrderDetailEntity':
			...
			return OrderDetailDataGoodsList().fromJson(json);			case 'MicroShareholderItemEntity':
			...
			return MicroShareholderItemInterests().fromJson(json);			case 'PayCouponEntity':
			...
			return TaskShareDataFooterImg().fromJson(json);			case 'SearchGoodsListEntity':
			...
			return PddGoodsInfoDataCoupons().fromJson(json);			case 'OrderListEntity':
			...
			return PddGoodsListDataListCoupons().fromJson(json);			case 'LoginEntity':
			return LoginEntity().fromJson(json);			case 'LoginData':
			return LoginData().fromJson(json);			case 'CategoryBeanEntity':
			return CategoryBeanEntity().fromJson(json);			case 'CategoryBeanData':
			return CategoryBeanData().fromJson(json);			case 'RechargeEntity':
			...
			return SearchPddGoodsListDataListCoupons().fromJson(json);			case 'WechatPayinfoEntity':
			...
			return HomeIconListIconList().fromJson(json);			case 'UserHolderProfitEntity':
			...
			return WithdrawalListDataList().fromJson(json);			case 'AddressListEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'OrderDetailEntity':
			...
			return List<OrderDetailDataGoodsList>();			case 'MicroShareholderItemEntity':
			...
			return List<MicroShareholderItemInterests>();			case 'PayCouponEntity':
			...
			return List<TaskShareDataFooterImg>();			case 'SearchGoodsListEntity':
			...
			return List<PddGoodsInfoDataCoupons>();			case 'OrderListEntity':
			...
			return List<PddGoodsListDataListCoupons>();			case 'LoginEntity':
			return List<LoginEntity>();			case 'LoginData':
			return List<LoginData>();			case 'CategoryBeanEntity':
			return List<CategoryBeanEntity>();			case 'CategoryBeanData':
			return List<CategoryBeanData>();			case 'RechargeEntity':
			...
			return List<SearchPddGoodsListDataListCoupons>();			case 'WechatPayinfoEntity':
			...
			return List<HomeIconListIconList>();			case 'UserHolderProfitEntity':
			...
			return List<WithdrawalListDataList>();			case 'AddressListEntity':
