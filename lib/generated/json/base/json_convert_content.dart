...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case VersionInfoEntity:
			return versionInfoEntityFromJson(data as VersionInfoEntity, json) as T;			case VersionInfoData:
			return versionInfoDataFromJson(data as VersionInfoData, json) as T;			case OrderDetailEntity:
			...
			return orderDetailDataGoodsListFromJson(data as OrderDetailDataGoodsList, json) as T;			case UserHolderProfitEntity:
			return userHolderProfitEntityFromJson(data as UserHolderProfitEntity, json) as T;			case UserHolderProfitPartnerBonus:
			return userHolderProfitPartnerBonusFromJson(data as UserHolderProfitPartnerBonus, json) as T;			case OrderUserInfoEntity:
			return orderUserInfoEntityFromJson(data as OrderUserInfoEntity, json) as T;			case OrderUserInfoUserInfo:
			return orderUserInfoUserInfoFromJson(data as OrderUserInfoUserInfo, json) as T;			case PayCouponEntity:
			return payCouponEntityFromJson(data as PayCouponEntity, json) as T;			case PayCouponData:
			return payCouponDataFromJson(data as PayCouponData, json) as T;			case VipPriceInfoEntity:
			...
			return vipPriceInfoDiamondMoneyListFromJson(data as VipPriceInfoDiamondMoneyList, json) as T;			case WithdrawalUserInfoEntity:
			...
			return withdrawalUserInfoDataUserFromJson(data as WithdrawalUserInfoDataUser, json) as T;			case GoodsQueueEntity:
			...
			return goodsQueueDataUserInfoFromJson(data as GoodsQueueDataUserInfo, json) as T;			case PddCategoryListEntity:
			return pddCategoryListEntityFromJson(data as PddCategoryListEntity, json) as T;			case PddCategoryListData:
			return pddCategoryListDataFromJson(data as PddCategoryListData, json) as T;			case GoodsInfoEntity:
			return goodsInfoEntityFromJson(data as GoodsInfoEntity, json) as T;			case GoodsInfoData:
			return goodsInfoDataFromJson(data as GoodsInfoData, json) as T;			case SearchGoodsListEntity:
			return searchGoodsListEntityFromJson(data as SearchGoodsListEntity, json) as T;			case SearchGoodsListData:
			return searchGoodsListDataFromJson(data as SearchGoodsListData, json) as T;			case SearchGoodsListDataList:
			return searchGoodsListDataListFromJson(data as SearchGoodsListDataList, json) as T;			case TaskOtherSubmitInfoEntity:
			return taskOtherSubmitInfoEntityFromJson(data as TaskOtherSubmitInfoEntity, json) as T;			case TaskOtherSubmitInfoData:
			return taskOtherSubmitInfoDataFromJson(data as TaskOtherSubmitInfoData, json) as T;			case PddHomeEntity:
			return pddHomeEntityFromJson(data as PddHomeEntity, json) as T;			case PddHomeData:
			return pddHomeDataFromJson(data as PddHomeData, json) as T;			case PddHomeDataCat:
			return pddHomeDataCatFromJson(data as PddHomeDataCat, json) as T;			case PddHomeDataBanner:
			return pddHomeDataBannerFromJson(data as PddHomeDataBanner, json) as T;			case PddHomeDataTool:
			return pddHomeDataToolFromJson(data as PddHomeDataTool, json) as T;			case PddHomeDataAd:
			return pddHomeDataAdFromJson(data as PddHomeDataAd, json) as T;			case WithdrawalListEntity:
			...
			return withdrawalListDataListFromJson(data as WithdrawalListDataList, json) as T;			case RechargeEntity:
			...
			return rechargeDatacouponListFromJson(data as RechargeDatacouponList, json) as T;			case PddGoodsInfoEntity:
			return pddGoodsInfoEntityFromJson(data as PddGoodsInfoEntity, json) as T;			case PddGoodsInfoData:
			return pddGoodsInfoDataFromJson(data as PddGoodsInfoData, json) as T;			case PddGoodsInfoDataCoupons:
			return pddGoodsInfoDataCouponsFromJson(data as PddGoodsInfoDataCoupons, json) as T;			case LogisticsInfoEntity:
			...
			return logisticsInfoDataExpressInfoFromJson(data as LogisticsInfoDataExpressInfo, json) as T;			case TaskDetailOtherEntity:
			...
			return wechatPayinfoDataPayInfoFromJson(data as WechatPayinfoDataPayInfo, json) as T;			case ShareholderIncomeListEntity:
			return shareholderIncomeListEntityFromJson(data as ShareholderIncomeListEntity, json) as T;			case TaskDetailEntity:
			return taskDetailEntityFromJson(data as TaskDetailEntity, json) as T;			case TaskDetailData:
			return taskDetailDataFromJson(data as TaskDetailData, json) as T;			case HomeIconListEntity:
			return homeIconListEntityFromJson(data as HomeIconListEntity, json) as T;			case HomeIconListIconList:
			return homeIconListIconListFromJson(data as HomeIconListIconList, json) as T;			case PosterEntity:
			return posterEntityFromJson(data as PosterEntity, json) as T;			case PosterData:
			return posterDataFromJson(data as PosterData, json) as T;			case LoginEntity:
			return loginEntityFromJson(data as LoginEntity, json) as T;			case LoginData:
			return loginDataFromJson(data as LoginData, json) as T;			case IncomeListEntity:
			...
			return incomeListDataListFromJson(data as IncomeListDataList, json) as T;			case WithdrawalInfoEntity:
			...
			return withdrawalInfoDataUseModelFromJson(data as WithdrawalInfoDataUseModel, json) as T;			case GoodsQueuePersionalEntity:
			return goodsQueuePersionalEntityFromJson(data as GoodsQueuePersionalEntity, json) as T;			case GoodsQueuePersionalData:
			return goodsQueuePersionalDataFromJson(data as GoodsQueuePersionalData, json) as T;			case OrderListEntity:
			...
			return addressListDataFromJson(data as AddressListData, json) as T;			case MicroShareholderItemEntity:
			...
			return microShareholderItemInterestsFromJson(data as MicroShareholderItemInterests, json) as T;			case HomeGoodsListEntity:
			return homeGoodsListEntityFromJson(data as HomeGoodsListEntity, json) as T;			case HomeGoodsListGoodsList:
			return homeGoodsListGoodsListFromJson(data as HomeGoodsListGoodsList, json) as T;			case PhoneChargeListEntity:
			...
			return phoneChargeListDataListFromJson(data as PhoneChargeListDataList, json) as T;			case HomeEntity:
			...
			return addressInfoDataFromJson(data as AddressInfoData, json) as T;			case TaskSubmitInfoEntity:
			return taskSubmitInfoEntityFromJson(data as TaskSubmitInfoEntity, json) as T;			case TaskSubmitInfoData:
			return taskSubmitInfoDataFromJson(data as TaskSubmitInfoData, json) as T;			case CategoryBeanEntity:
			return categoryBeanEntityFromJson(data as CategoryBeanEntity, json) as T;			case CategoryBeanData:
			return categoryBeanDataFromJson(data as CategoryBeanData, json) as T;			case MicroShareholderEntity:
			return microShareholderEntityFromJson(data as MicroShareholderEntity, json) as T;			case MicroShareholderData:
			return microShareholderDataFromJson(data as MicroShareholderData, json) as T;			case BalancePayInfoEntity:
			return balancePayInfoEntityFromJson(data as BalancePayInfoEntity, json) as T;			case BalancePayInfoData:
			return balancePayInfoDataFromJson(data as BalancePayInfoData, json) as T;			case TaskShareEntity:
			...
			return taskShareDataFooterImgFromJson(data as TaskShareDataFooterImg, json) as T;			case VipPriceEntity:
			return vipPriceEntityFromJson(data as VipPriceEntity, json) as T;			case VipPriceData:
			return vipPriceDataFromJson(data as VipPriceData, json) as T;			case SearchPddGoodsListEntity:
			return searchPddGoodsListEntityFromJson(data as SearchPddGoodsListEntity, json) as T;			case SearchPddGoodsListData:
			return searchPddGoodsListDataFromJson(data as SearchPddGoodsListData, json) as T;			case SearchPddGoodsListDataList:
			return searchPddGoodsListDataListFromJson(data as SearchPddGoodsListDataList, json) as T;			case SearchPddGoodsListDataListCoupons:
			return searchPddGoodsListDataListCouponsFromJson(data as SearchPddGoodsListDataListCoupons, json) as T;			case MessageListEntity:
			...
			return messageListDataListFromJson(data as MessageListDataList, json) as T;			case FansTotalEntity:
			...
			return fansTotalDataCountInfoFromJson(data as FansTotalDataCountInfo, json) as T;			case RegionDataEntity:
			...
			return regionDataDatachildchildFromJson(data as RegionDataDatachildchild, json) as T;			case HomePddCategoryEntity:
			...
			return homePddCategoryDataCatFromJson(data as HomePddCategoryDataCat, json) as T;			case FansListEntity:
			...
			return fansListDataListFromJson(data as FansListDataList, json) as T;			case PddGoodsListEntity:
			return pddGoodsListEntityFromJson(data as PddGoodsListEntity, json) as T;			case PddGoodsListData:
			return pddGoodsListDataFromJson(data as PddGoodsListData, json) as T;			case PddGoodsListDataList:
			return pddGoodsListDataListFromJson(data as PddGoodsListDataList, json) as T;			case PddGoodsListDataListCoupons:
			return pddGoodsListDataListCouponsFromJson(data as PddGoodsListDataListCoupons, json) as T;			case TaskRecordListEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case VersionInfoEntity:
			...
			return versionInfoDataToJson(data as VersionInfoData);			case OrderDetailEntity:
			...
			return orderDetailDataGoodsListToJson(data as OrderDetailDataGoodsList);			case UserHolderProfitEntity:
			return userHolderProfitEntityToJson(data as UserHolderProfitEntity);			case UserHolderProfitPartnerBonus:
			return userHolderProfitPartnerBonusToJson(data as UserHolderProfitPartnerBonus);			case OrderUserInfoEntity:
			return orderUserInfoEntityToJson(data as OrderUserInfoEntity);			case OrderUserInfoUserInfo:
			return orderUserInfoUserInfoToJson(data as OrderUserInfoUserInfo);			case PayCouponEntity:
			return payCouponEntityToJson(data as PayCouponEntity);			case PayCouponData:
			return payCouponDataToJson(data as PayCouponData);			case VipPriceInfoEntity:
			...
			return vipPriceInfoDiamondMoneyListToJson(data as VipPriceInfoDiamondMoneyList);			case WithdrawalUserInfoEntity:
			...
			return withdrawalUserInfoDataUserToJson(data as WithdrawalUserInfoDataUser);			case GoodsQueueEntity:
			...
			return goodsQueueDataUserInfoToJson(data as GoodsQueueDataUserInfo);			case PddCategoryListEntity:
			return pddCategoryListEntityToJson(data as PddCategoryListEntity);			case PddCategoryListData:
			return pddCategoryListDataToJson(data as PddCategoryListData);			case GoodsInfoEntity:
			return goodsInfoEntityToJson(data as GoodsInfoEntity);			case GoodsInfoData:
			return goodsInfoDataToJson(data as GoodsInfoData);			case SearchGoodsListEntity:
			return searchGoodsListEntityToJson(data as SearchGoodsListEntity);			case SearchGoodsListData:
			return searchGoodsListDataToJson(data as SearchGoodsListData);			case SearchGoodsListDataList:
			return searchGoodsListDataListToJson(data as SearchGoodsListDataList);			case TaskOtherSubmitInfoEntity:
			return taskOtherSubmitInfoEntityToJson(data as TaskOtherSubmitInfoEntity);			case TaskOtherSubmitInfoData:
			return taskOtherSubmitInfoDataToJson(data as TaskOtherSubmitInfoData);			case PddHomeEntity:
			return pddHomeEntityToJson(data as PddHomeEntity);			case PddHomeData:
			return pddHomeDataToJson(data as PddHomeData);			case PddHomeDataCat:
			return pddHomeDataCatToJson(data as PddHomeDataCat);			case PddHomeDataBanner:
			return pddHomeDataBannerToJson(data as PddHomeDataBanner);			case PddHomeDataTool:
			return pddHomeDataToolToJson(data as PddHomeDataTool);			case PddHomeDataAd:
			return pddHomeDataAdToJson(data as PddHomeDataAd);			case WithdrawalListEntity:
			...
			return withdrawalListDataListToJson(data as WithdrawalListDataList);			case RechargeEntity:
			...
			return rechargeDatacouponListToJson(data as RechargeDatacouponList);			case PddGoodsInfoEntity:
			return pddGoodsInfoEntityToJson(data as PddGoodsInfoEntity);			case PddGoodsInfoData:
			return pddGoodsInfoDataToJson(data as PddGoodsInfoData);			case PddGoodsInfoDataCoupons:
			return pddGoodsInfoDataCouponsToJson(data as PddGoodsInfoDataCoupons);			case LogisticsInfoEntity:
			...
			return logisticsInfoDataExpressInfoToJson(data as LogisticsInfoDataExpressInfo);			case TaskDetailOtherEntity:
			...
			return wechatPayinfoDataPayInfoToJson(data as WechatPayinfoDataPayInfo);			case ShareholderIncomeListEntity:
			return shareholderIncomeListEntityToJson(data as ShareholderIncomeListEntity);			case TaskDetailEntity:
			return taskDetailEntityToJson(data as TaskDetailEntity);			case TaskDetailData:
			return taskDetailDataToJson(data as TaskDetailData);			case HomeIconListEntity:
			return homeIconListEntityToJson(data as HomeIconListEntity);			case HomeIconListIconList:
			return homeIconListIconListToJson(data as HomeIconListIconList);			case PosterEntity:
			return posterEntityToJson(data as PosterEntity);			case PosterData:
			return posterDataToJson(data as PosterData);			case LoginEntity:
			return loginEntityToJson(data as LoginEntity);			case LoginData:
			return loginDataToJson(data as LoginData);			case IncomeListEntity:
			...
			return incomeListDataListToJson(data as IncomeListDataList);			case WithdrawalInfoEntity:
			...
			return withdrawalInfoDataUseModelToJson(data as WithdrawalInfoDataUseModel);			case GoodsQueuePersionalEntity:
			return goodsQueuePersionalEntityToJson(data as GoodsQueuePersionalEntity);			case GoodsQueuePersionalData:
			return goodsQueuePersionalDataToJson(data as GoodsQueuePersionalData);			case OrderListEntity:
			...
			return addressListDataToJson(data as AddressListData);			case MicroShareholderItemEntity:
			...
			return microShareholderItemInterestsToJson(data as MicroShareholderItemInterests);			case HomeGoodsListEntity:
			return homeGoodsListEntityToJson(data as HomeGoodsListEntity);			case HomeGoodsListGoodsList:
			return homeGoodsListGoodsListToJson(data as HomeGoodsListGoodsList);			case PhoneChargeListEntity:
			...
			return phoneChargeListDataListToJson(data as PhoneChargeListDataList);			case HomeEntity:
			...
			return addressInfoDataToJson(data as AddressInfoData);			case TaskSubmitInfoEntity:
			return taskSubmitInfoEntityToJson(data as TaskSubmitInfoEntity);			case TaskSubmitInfoData:
			return taskSubmitInfoDataToJson(data as TaskSubmitInfoData);			case CategoryBeanEntity:
			return categoryBeanEntityToJson(data as CategoryBeanEntity);			case CategoryBeanData:
			return categoryBeanDataToJson(data as CategoryBeanData);			case MicroShareholderEntity:
			return microShareholderEntityToJson(data as MicroShareholderEntity);			case MicroShareholderData:
			return microShareholderDataToJson(data as MicroShareholderData);			case BalancePayInfoEntity:
			return balancePayInfoEntityToJson(data as BalancePayInfoEntity);			case BalancePayInfoData:
			return balancePayInfoDataToJson(data as BalancePayInfoData);			case TaskShareEntity:
			...
			return taskShareDataFooterImgToJson(data as TaskShareDataFooterImg);			case VipPriceEntity:
			return vipPriceEntityToJson(data as VipPriceEntity);			case VipPriceData:
			return vipPriceDataToJson(data as VipPriceData);			case SearchPddGoodsListEntity:
			return searchPddGoodsListEntityToJson(data as SearchPddGoodsListEntity);			case SearchPddGoodsListData:
			return searchPddGoodsListDataToJson(data as SearchPddGoodsListData);			case SearchPddGoodsListDataList:
			return searchPddGoodsListDataListToJson(data as SearchPddGoodsListDataList);			case SearchPddGoodsListDataListCoupons:
			return searchPddGoodsListDataListCouponsToJson(data as SearchPddGoodsListDataListCoupons);			case MessageListEntity:
			...
			return messageListDataListToJson(data as MessageListDataList);			case FansTotalEntity:
			...
			return fansTotalDataCountInfoToJson(data as FansTotalDataCountInfo);			case RegionDataEntity:
			...
			return regionDataDatachildchildToJson(data as RegionDataDatachildchild);			case HomePddCategoryEntity:
			...
			return homePddCategoryDataCatToJson(data as HomePddCategoryDataCat);			case FansListEntity:
			...
			return fansListDataListToJson(data as FansListDataList);			case PddGoodsListEntity:
			return pddGoodsListEntityToJson(data as PddGoodsListEntity);			case PddGoodsListData:
			return pddGoodsListDataToJson(data as PddGoodsListData);			case PddGoodsListDataList:
			return pddGoodsListDataListToJson(data as PddGoodsListDataList);			case PddGoodsListDataListCoupons:
			return pddGoodsListDataListCouponsToJson(data as PddGoodsListDataListCoupons);			case TaskRecordListEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'VersionInfoEntity':
			...
			return VersionInfoData().fromJson(json);			case 'OrderDetailEntity':
			...
			return OrderDetailDataGoodsList().fromJson(json);			case 'UserHolderProfitEntity':
			return UserHolderProfitEntity().fromJson(json);			case 'UserHolderProfitPartnerBonus':
			return UserHolderProfitPartnerBonus().fromJson(json);			case 'OrderUserInfoEntity':
			return OrderUserInfoEntity().fromJson(json);			case 'OrderUserInfoUserInfo':
			return OrderUserInfoUserInfo().fromJson(json);			case 'PayCouponEntity':
			return PayCouponEntity().fromJson(json);			case 'PayCouponData':
			return PayCouponData().fromJson(json);			case 'VipPriceInfoEntity':
			...
			return VipPriceInfoDiamondMoneyList().fromJson(json);			case 'WithdrawalUserInfoEntity':
			...
			return WithdrawalUserInfoDataUser().fromJson(json);			case 'GoodsQueueEntity':
			...
			return GoodsQueueDataUserInfo().fromJson(json);			case 'PddCategoryListEntity':
			return PddCategoryListEntity().fromJson(json);			case 'PddCategoryListData':
			return PddCategoryListData().fromJson(json);			case 'GoodsInfoEntity':
			return GoodsInfoEntity().fromJson(json);			case 'GoodsInfoData':
			return GoodsInfoData().fromJson(json);			case 'SearchGoodsListEntity':
			return SearchGoodsListEntity().fromJson(json);			case 'SearchGoodsListData':
			return SearchGoodsListData().fromJson(json);			case 'SearchGoodsListDataList':
			return SearchGoodsListDataList().fromJson(json);			case 'TaskOtherSubmitInfoEntity':
			return TaskOtherSubmitInfoEntity().fromJson(json);			case 'TaskOtherSubmitInfoData':
			return TaskOtherSubmitInfoData().fromJson(json);			case 'PddHomeEntity':
			return PddHomeEntity().fromJson(json);			case 'PddHomeData':
			return PddHomeData().fromJson(json);			case 'PddHomeDataCat':
			return PddHomeDataCat().fromJson(json);			case 'PddHomeDataBanner':
			return PddHomeDataBanner().fromJson(json);			case 'PddHomeDataTool':
			return PddHomeDataTool().fromJson(json);			case 'PddHomeDataAd':
			return PddHomeDataAd().fromJson(json);			case 'WithdrawalListEntity':
			...
			return WithdrawalListDataList().fromJson(json);			case 'RechargeEntity':
			...
			return RechargeDatacouponList().fromJson(json);			case 'PddGoodsInfoEntity':
			return PddGoodsInfoEntity().fromJson(json);			case 'PddGoodsInfoData':
			return PddGoodsInfoData().fromJson(json);			case 'PddGoodsInfoDataCoupons':
			return PddGoodsInfoDataCoupons().fromJson(json);			case 'LogisticsInfoEntity':
			...
			return LogisticsInfoDataExpressInfo().fromJson(json);			case 'TaskDetailOtherEntity':
			...
			return WechatPayinfoDataPayInfo().fromJson(json);			case 'ShareholderIncomeListEntity':
			return ShareholderIncomeListEntity().fromJson(json);			case 'TaskDetailEntity':
			return TaskDetailEntity().fromJson(json);			case 'TaskDetailData':
			return TaskDetailData().fromJson(json);			case 'HomeIconListEntity':
			return HomeIconListEntity().fromJson(json);			case 'HomeIconListIconList':
			return HomeIconListIconList().fromJson(json);			case 'PosterEntity':
			return PosterEntity().fromJson(json);			case 'PosterData':
			return PosterData().fromJson(json);			case 'LoginEntity':
			return LoginEntity().fromJson(json);			case 'LoginData':
			return LoginData().fromJson(json);			case 'IncomeListEntity':
			return IncomeListEntity().fromJson(json);			case 'IncomeListData':
			return IncomeListData().fromJson(json);			case 'IncomeListDataList':
			return IncomeListDataList().fromJson(json);			case 'WithdrawalInfoEntity':
			...
			return WithdrawalInfoDataUseModel().fromJson(json);			case 'GoodsQueuePersionalEntity':
			return GoodsQueuePersionalEntity().fromJson(json);			case 'GoodsQueuePersionalData':
			return GoodsQueuePersionalData().fromJson(json);			case 'OrderListEntity':
			...
			return AddressListData().fromJson(json);			case 'MicroShareholderItemEntity':
			...
			return MicroShareholderItemInterests().fromJson(json);			case 'HomeGoodsListEntity':
			return HomeGoodsListEntity().fromJson(json);			case 'HomeGoodsListGoodsList':
			return HomeGoodsListGoodsList().fromJson(json);			case 'PhoneChargeListEntity':
			...
			return PhoneChargeListDataList().fromJson(json);			case 'HomeEntity':
			...
			return AddressInfoData().fromJson(json);			case 'TaskSubmitInfoEntity':
			return TaskSubmitInfoEntity().fromJson(json);			case 'TaskSubmitInfoData':
			return TaskSubmitInfoData().fromJson(json);			case 'CategoryBeanEntity':
			return CategoryBeanEntity().fromJson(json);			case 'CategoryBeanData':
			return CategoryBeanData().fromJson(json);			case 'MicroShareholderEntity':
			return MicroShareholderEntity().fromJson(json);			case 'MicroShareholderData':
			return MicroShareholderData().fromJson(json);			case 'BalancePayInfoEntity':
			return BalancePayInfoEntity().fromJson(json);			case 'BalancePayInfoData':
			return BalancePayInfoData().fromJson(json);			case 'TaskShareEntity':
			...
			return TaskShareDataFooterImg().fromJson(json);			case 'VipPriceEntity':
			return VipPriceEntity().fromJson(json);			case 'VipPriceData':
			return VipPriceData().fromJson(json);			case 'SearchPddGoodsListEntity':
			return SearchPddGoodsListEntity().fromJson(json);			case 'SearchPddGoodsListData':
			return SearchPddGoodsListData().fromJson(json);			case 'SearchPddGoodsListDataList':
			return SearchPddGoodsListDataList().fromJson(json);			case 'SearchPddGoodsListDataListCoupons':
			return SearchPddGoodsListDataListCoupons().fromJson(json);			case 'MessageListEntity':
			return MessageListEntity().fromJson(json);			case 'MessageListData':
			return MessageListData().fromJson(json);			case 'MessageListDataList':
			return MessageListDataList().fromJson(json);			case 'FansTotalEntity':
			...
			return FansTotalDataCountInfo().fromJson(json);			case 'RegionDataEntity':
			...
			return RegionDataDatachildchild().fromJson(json);			case 'HomePddCategoryEntity':
			...
			return HomePddCategoryDataCat().fromJson(json);			case 'FansListEntity':
			return FansListEntity().fromJson(json);			case 'FansListData':
			return FansListData().fromJson(json);			case 'FansListDataList':
			return FansListDataList().fromJson(json);			case 'PddGoodsListEntity':
			return PddGoodsListEntity().fromJson(json);			case 'PddGoodsListData':
			return PddGoodsListData().fromJson(json);			case 'PddGoodsListDataList':
			return PddGoodsListDataList().fromJson(json);			case 'PddGoodsListDataListCoupons':
			return PddGoodsListDataListCoupons().fromJson(json);			case 'TaskRecordListEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'VersionInfoEntity':
			...
			return List<VersionInfoData>();			case 'OrderDetailEntity':
			return List<OrderDetailEntity>();			case 'OrderDetailData':
			return List<OrderDetailData>();			case 'OrderDetailDataGoodsList':
			return List<OrderDetailDataGoodsList>();			case 'UserHolderProfitEntity':
			return List<UserHolderProfitEntity>();			case 'UserHolderProfitPartnerBonus':
			return List<UserHolderProfitPartnerBonus>();			case 'OrderUserInfoEntity':
			return List<OrderUserInfoEntity>();			case 'OrderUserInfoUserInfo':
			return List<OrderUserInfoUserInfo>();			case 'PayCouponEntity':
			return List<PayCouponEntity>();			case 'PayCouponData':
			return List<PayCouponData>();			case 'VipPriceInfoEntity':
			...
			return List<VipPriceInfoDiamondMoneyList>();			case 'WithdrawalUserInfoEntity':
			...
			return List<WithdrawalUserInfoDataUser>();			case 'GoodsQueueEntity':
			...
			return List<GoodsQueueDataUserInfo>();			case 'PddCategoryListEntity':
			return List<PddCategoryListEntity>();			case 'PddCategoryListData':
			return List<PddCategoryListData>();			case 'GoodsInfoEntity':
			return List<GoodsInfoEntity>();			case 'GoodsInfoData':
			return List<GoodsInfoData>();			case 'SearchGoodsListEntity':
			return List<SearchGoodsListEntity>();			case 'SearchGoodsListData':
			return List<SearchGoodsListData>();			case 'SearchGoodsListDataList':
			return List<SearchGoodsListDataList>();			case 'TaskOtherSubmitInfoEntity':
			return List<TaskOtherSubmitInfoEntity>();			case 'TaskOtherSubmitInfoData':
			return List<TaskOtherSubmitInfoData>();			case 'PddHomeEntity':
			return List<PddHomeEntity>();			case 'PddHomeData':
			return List<PddHomeData>();			case 'PddHomeDataCat':
			return List<PddHomeDataCat>();			case 'PddHomeDataBanner':
			return List<PddHomeDataBanner>();			case 'PddHomeDataTool':
			return List<PddHomeDataTool>();			case 'PddHomeDataAd':
			return List<PddHomeDataAd>();			case 'WithdrawalListEntity':
			return List<WithdrawalListEntity>();			case 'WithdrawalListData':
			return List<WithdrawalListData>();			case 'WithdrawalListDataList':
			return List<WithdrawalListDataList>();			case 'RechargeEntity':
			...
			return List<RechargeDatacouponList>();			case 'PddGoodsInfoEntity':
			return List<PddGoodsInfoEntity>();			case 'PddGoodsInfoData':
			return List<PddGoodsInfoData>();			case 'PddGoodsInfoDataCoupons':
			return List<PddGoodsInfoDataCoupons>();			case 'LogisticsInfoEntity':
			...
			return List<LogisticsInfoDataExpressInfo>();			case 'TaskDetailOtherEntity':
			...
			return List<WechatPayinfoDataPayInfo>();			case 'ShareholderIncomeListEntity':
			return List<ShareholderIncomeListEntity>();			case 'TaskDetailEntity':
			return List<TaskDetailEntity>();			case 'TaskDetailData':
			return List<TaskDetailData>();			case 'HomeIconListEntity':
			return List<HomeIconListEntity>();			case 'HomeIconListIconList':
			return List<HomeIconListIconList>();			case 'PosterEntity':
			return List<PosterEntity>();			case 'PosterData':
			return List<PosterData>();			case 'LoginEntity':
			return List<LoginEntity>();			case 'LoginData':
			return List<LoginData>();			case 'IncomeListEntity':
			return List<IncomeListEntity>();			case 'IncomeListData':
			return List<IncomeListData>();			case 'IncomeListDataList':
			return List<IncomeListDataList>();			case 'WithdrawalInfoEntity':
			...
			return List<WithdrawalInfoDataUseModel>();			case 'GoodsQueuePersionalEntity':
			return List<GoodsQueuePersionalEntity>();			case 'GoodsQueuePersionalData':
			return List<GoodsQueuePersionalData>();			case 'OrderListEntity':
			...
			return List<AddressListData>();			case 'MicroShareholderItemEntity':
			...
			return List<MicroShareholderItemInterests>();			case 'HomeGoodsListEntity':
			return List<HomeGoodsListEntity>();			case 'HomeGoodsListGoodsList':
			return List<HomeGoodsListGoodsList>();			case 'PhoneChargeListEntity':
			return List<PhoneChargeListEntity>();			case 'PhoneChargeListData':
			return List<PhoneChargeListData>();			case 'PhoneChargeListDataList':
			return List<PhoneChargeListDataList>();			case 'HomeEntity':
			...
			return List<AddressInfoData>();			case 'TaskSubmitInfoEntity':
			return List<TaskSubmitInfoEntity>();			case 'TaskSubmitInfoData':
			return List<TaskSubmitInfoData>();			case 'CategoryBeanEntity':
			return List<CategoryBeanEntity>();			case 'CategoryBeanData':
			return List<CategoryBeanData>();			case 'MicroShareholderEntity':
			return List<MicroShareholderEntity>();			case 'MicroShareholderData':
			return List<MicroShareholderData>();			case 'BalancePayInfoEntity':
			return List<BalancePayInfoEntity>();			case 'BalancePayInfoData':
			return List<BalancePayInfoData>();			case 'TaskShareEntity':
			...
			return List<TaskShareDataFooterImg>();			case 'VipPriceEntity':
			return List<VipPriceEntity>();			case 'VipPriceData':
			return List<VipPriceData>();			case 'SearchPddGoodsListEntity':
			return List<SearchPddGoodsListEntity>();			case 'SearchPddGoodsListData':
			return List<SearchPddGoodsListData>();			case 'SearchPddGoodsListDataList':
			return List<SearchPddGoodsListDataList>();			case 'SearchPddGoodsListDataListCoupons':
			return List<SearchPddGoodsListDataListCoupons>();			case 'MessageListEntity':
			return List<MessageListEntity>();			case 'MessageListData':
			return List<MessageListData>();			case 'MessageListDataList':
			return List<MessageListDataList>();			case 'FansTotalEntity':
			...
			return List<FansTotalDataCountInfo>();			case 'RegionDataEntity':
			...
			return List<RegionDataDatachildchild>();			case 'HomePddCategoryEntity':
			return List<HomePddCategoryEntity>();			case 'HomePddCategoryData':
			return List<HomePddCategoryData>();			case 'HomePddCategoryDataCat':
			return List<HomePddCategoryDataCat>();			case 'FansListEntity':
			return List<FansListEntity>();			case 'FansListData':
			return List<FansListData>();			case 'FansListDataList':
			return List<FansListDataList>();			case 'PddGoodsListEntity':
			return List<PddGoodsListEntity>();			case 'PddGoodsListData':
			return List<PddGoodsListData>();			case 'PddGoodsListDataList':
			return List<PddGoodsListDataList>();			case 'PddGoodsListDataListCoupons':
			return List<PddGoodsListDataListCoupons>();			case 'TaskRecordListEntity':
