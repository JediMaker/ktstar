...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case VipPriceEntity:
			...
			return vipPriceDataFromJson(data as VipPriceData, json) as T;			case RechargeEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case VipPriceEntity:
			...
			return vipPriceDataToJson(data as VipPriceData);			case RechargeEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'VipPriceEntity':
			...
			return VipPriceData().fromJson(json);			case 'RechargeEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'VipPriceEntity':
			...
			return List<VipPriceData>();			case 'RechargeEntity':
