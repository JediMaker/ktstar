...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case PosterEntity:
			...
			return homeDataTaskListListFromJson(data as HomeDataTaskListList, json) as T;			case FansTotalEntity:
			...
			return fansTotalDataCountInfoFromJson(data as FansTotalDataCountInfo, json) as T;			case RechargeEntity:
			...
			return messageListDataListFromJson(data as MessageListDataList, json) as T;			case PayCouponEntity:
			return payCouponEntityFromJson(data as PayCouponEntity, json) as T;			case PayCouponData:
			return payCouponDataFromJson(data as PayCouponData, json) as T;			case TaskSubmitInfoEntity:
			return taskSubmitInfoEntityFromJson(data as TaskSubmitInfoEntity, json) as T;			case TaskSubmitInfoData:
			return taskSubmitInfoDataFromJson(data as TaskSubmitInfoData, json) as T;			case UserInfoEntity:
			return userInfoEntityFromJson(data as UserInfoEntity, json) as T;			case UserInfoData:
			return userInfoDataFromJson(data as UserInfoData, json) as T;			case FansListEntity:
			...
			return wechatPayinfoDataPayInfoFromJson(data as WechatPayinfoDataPayInfo, json) as T;			case VipPriceEntity:
			return vipPriceEntityFromJson(data as VipPriceEntity, json) as T;			case VipPriceData:
			return vipPriceDataFromJson(data as VipPriceData, json) as T;			case PhoneChargeListEntity:
			...
			return phoneChargeListDataListFromJson(data as PhoneChargeListDataList, json) as T;			case TaskRecordListEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case PosterEntity:
			...
			return homeDataTaskListListToJson(data as HomeDataTaskListList);			case FansTotalEntity:
			...
			return fansTotalDataCountInfoToJson(data as FansTotalDataCountInfo);			case RechargeEntity:
			...
			return messageListDataListToJson(data as MessageListDataList);			case PayCouponEntity:
			return payCouponEntityToJson(data as PayCouponEntity);			case PayCouponData:
			return payCouponDataToJson(data as PayCouponData);			case TaskSubmitInfoEntity:
			return taskSubmitInfoEntityToJson(data as TaskSubmitInfoEntity);			case TaskSubmitInfoData:
			return taskSubmitInfoDataToJson(data as TaskSubmitInfoData);			case UserInfoEntity:
			return userInfoEntityToJson(data as UserInfoEntity);			case UserInfoData:
			return userInfoDataToJson(data as UserInfoData);			case FansListEntity:
			...
			return wechatPayinfoDataPayInfoToJson(data as WechatPayinfoDataPayInfo);			case VipPriceEntity:
			return vipPriceEntityToJson(data as VipPriceEntity);			case VipPriceData:
			return vipPriceDataToJson(data as VipPriceData);			case PhoneChargeListEntity:
			...
			return phoneChargeListDataListToJson(data as PhoneChargeListDataList);			case TaskRecordListEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'PosterEntity':
			...
			return HomeDataTaskListList().fromJson(json);			case 'FansTotalEntity':
			...
			return FansTotalDataCountInfo().fromJson(json);			case 'RechargeEntity':
			...
			return MessageListDataList().fromJson(json);			case 'PayCouponEntity':
			return PayCouponEntity().fromJson(json);			case 'PayCouponData':
			return PayCouponData().fromJson(json);			case 'TaskSubmitInfoEntity':
			return TaskSubmitInfoEntity().fromJson(json);			case 'TaskSubmitInfoData':
			return TaskSubmitInfoData().fromJson(json);			case 'UserInfoEntity':
			return UserInfoEntity().fromJson(json);			case 'UserInfoData':
			return UserInfoData().fromJson(json);			case 'FansListEntity':
			...
			return WechatPayinfoDataPayInfo().fromJson(json);			case 'VipPriceEntity':
			return VipPriceEntity().fromJson(json);			case 'VipPriceData':
			return VipPriceData().fromJson(json);			case 'PhoneChargeListEntity':
			...
			return PhoneChargeListDataList().fromJson(json);			case 'TaskRecordListEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'PosterEntity':
			...
			return List<HomeDataTaskListList>();			case 'FansTotalEntity':
			...
			return List<FansTotalDataCountInfo>();			case 'RechargeEntity':
			...
			return List<MessageListDataList>();			case 'PayCouponEntity':
			return List<PayCouponEntity>();			case 'PayCouponData':
			return List<PayCouponData>();			case 'TaskSubmitInfoEntity':
			return List<TaskSubmitInfoEntity>();			case 'TaskSubmitInfoData':
			return List<TaskSubmitInfoData>();			case 'UserInfoEntity':
			return List<UserInfoEntity>();			case 'UserInfoData':
			return List<UserInfoData>();			case 'FansListEntity':
			...
			return List<WechatPayinfoDataPayInfo>();			case 'VipPriceEntity':
			return List<VipPriceEntity>();			case 'VipPriceData':
			return List<VipPriceData>();			case 'PhoneChargeListEntity':
			return List<PhoneChargeListEntity>();			case 'PhoneChargeListData':
			return List<PhoneChargeListData>();			case 'PhoneChargeListDataList':
			return List<PhoneChargeListDataList>();			case 'TaskRecordListEntity':
