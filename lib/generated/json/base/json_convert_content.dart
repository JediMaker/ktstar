...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case FansTotalEntity:
			...
			return fansTotalDataCountInfoFromJson(data as FansTotalDataCountInfo, json) as T;			case PayCouponEntity:
			...
			return taskShareDataFooterImgFromJson(data as TaskShareDataFooterImg, json) as T;			case MicroShareholderItemEntity:
			...
			return microShareholderItemInterestsFromJson(data as MicroShareholderItemInterests, json) as T;			case SearchGoodsListEntity:
			...
			return searchGoodsListDataListFromJson(data as SearchGoodsListDataList, json) as T;			case WithdrawalInfoEntity:
			...
			return goodsQueuePersionalDataFromJson(data as GoodsQueuePersionalData, json) as T;			case PddGoodsInfoEntity:
			...
			return pddGoodsInfoDataCouponsFromJson(data as PddGoodsInfoDataCoupons, json) as T;			case CategoryBeanEntity:
			return categoryBeanEntityFromJson(data as CategoryBeanEntity, json) as T;			case CategoryBeanData:
			return categoryBeanDataFromJson(data as CategoryBeanData, json) as T;			case TaskSubmitInfoEntity:
			return taskSubmitInfoEntityFromJson(data as TaskSubmitInfoEntity, json) as T;			case TaskSubmitInfoData:
			return taskSubmitInfoDataFromJson(data as TaskSubmitInfoData, json) as T;			case OrderListEntity:
			...
			return orderListDataListGoodsListFromJson(data as OrderListDataListGoodsList, json) as T;			case PosterEntity:
			return posterEntityFromJson(data as PosterEntity, json) as T;			case PosterData:
			return posterDataFromJson(data as PosterData, json) as T;			case PddGoodsListEntity:
			...
			return pddGoodsListDataListCouponsFromJson(data as PddGoodsListDataListCoupons, json) as T;			case RechargeEntity:
			...
			return rechargeDatacouponListFromJson(data as RechargeDatacouponList, json) as T;			case SearchPddGoodsListEntity:
			...
			return searchPddGoodsListDataListCouponsFromJson(data as SearchPddGoodsListDataListCoupons, json) as T;			case GoodsQueueEntity:
			...
			return microShareholderDataFromJson(data as MicroShareholderData, json) as T;			case ShareholderIncomeListEntity:
			return shareholderIncomeListEntityFromJson(data as ShareholderIncomeListEntity, json) as T;			case ResultBeanEntity:
			...
			return homeIconListIconListFromJson(data as HomeIconListIconList, json) as T;			case OrderDetailEntity:
			...
			return orderUserInfoUserInfoFromJson(data as OrderUserInfoUserInfo, json) as T;			case UserHolderProfitEntity:
			return userHolderProfitEntityFromJson(data as UserHolderProfitEntity, json) as T;			case UserHolderProfitPartnerBonus:
			return userHolderProfitPartnerBonusFromJson(data as UserHolderProfitPartnerBonus, json) as T;			case HomeEntity:
			...
			return homeDataTaskListListFromJson(data as HomeDataTaskListList, json) as T;			case MessageListEntity:
			...
			return messageListDataListFromJson(data as MessageListDataList, json) as T;			case PddCategoryListEntity:
			return pddCategoryListEntityFromJson(data as PddCategoryListEntity, json) as T;			case PddCategoryListData:
			return pddCategoryListDataFromJson(data as PddCategoryListData, json) as T;			case VersionInfoEntity:
			...
			return addressInfoDataFromJson(data as AddressInfoData, json) as T;			case LogisticsInfoEntity:
			...
			return logisticsInfoDataExpressInfoFromJson(data as LogisticsInfoDataExpressInfo, json) as T;			case PhoneChargeListEntity:
			...
			return pddHomeDataAdFromJson(data as PddHomeDataAd, json) as T;			case TaskOtherSubmitInfoEntity:
			return taskOtherSubmitInfoEntityFromJson(data as TaskOtherSubmitInfoEntity, json) as T;			case TaskOtherSubmitInfoData:
			return taskOtherSubmitInfoDataFromJson(data as TaskOtherSubmitInfoData, json) as T;			case HomePddCategoryEntity:
			...
			return homePddCategoryDataCatFromJson(data as HomePddCategoryDataCat, json) as T;			case GoodsSpecInfoEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case FansTotalEntity:
			...
			return fansTotalDataCountInfoToJson(data as FansTotalDataCountInfo);			case PayCouponEntity:
			...
			return taskShareDataFooterImgToJson(data as TaskShareDataFooterImg);			case MicroShareholderItemEntity:
			...
			return microShareholderItemInterestsToJson(data as MicroShareholderItemInterests);			case SearchGoodsListEntity:
			...
			return searchGoodsListDataListToJson(data as SearchGoodsListDataList);			case WithdrawalInfoEntity:
			...
			return goodsQueuePersionalDataToJson(data as GoodsQueuePersionalData);			case PddGoodsInfoEntity:
			...
			return pddGoodsInfoDataCouponsToJson(data as PddGoodsInfoDataCoupons);			case CategoryBeanEntity:
			return categoryBeanEntityToJson(data as CategoryBeanEntity);			case CategoryBeanData:
			return categoryBeanDataToJson(data as CategoryBeanData);			case TaskSubmitInfoEntity:
			return taskSubmitInfoEntityToJson(data as TaskSubmitInfoEntity);			case TaskSubmitInfoData:
			return taskSubmitInfoDataToJson(data as TaskSubmitInfoData);			case OrderListEntity:
			...
			return orderListDataListGoodsListToJson(data as OrderListDataListGoodsList);			case PosterEntity:
			return posterEntityToJson(data as PosterEntity);			case PosterData:
			return posterDataToJson(data as PosterData);			case PddGoodsListEntity:
			...
			return pddGoodsListDataListCouponsToJson(data as PddGoodsListDataListCoupons);			case RechargeEntity:
			...
			return rechargeDatacouponListToJson(data as RechargeDatacouponList);			case SearchPddGoodsListEntity:
			...
			return searchPddGoodsListDataListCouponsToJson(data as SearchPddGoodsListDataListCoupons);			case GoodsQueueEntity:
			...
			return microShareholderDataToJson(data as MicroShareholderData);			case ShareholderIncomeListEntity:
			return shareholderIncomeListEntityToJson(data as ShareholderIncomeListEntity);			case ResultBeanEntity:
			...
			return homeIconListIconListToJson(data as HomeIconListIconList);			case OrderDetailEntity:
			...
			return orderUserInfoUserInfoToJson(data as OrderUserInfoUserInfo);			case UserHolderProfitEntity:
			return userHolderProfitEntityToJson(data as UserHolderProfitEntity);			case UserHolderProfitPartnerBonus:
			return userHolderProfitPartnerBonusToJson(data as UserHolderProfitPartnerBonus);			case HomeEntity:
			...
			return homeDataTaskListListToJson(data as HomeDataTaskListList);			case MessageListEntity:
			...
			return messageListDataListToJson(data as MessageListDataList);			case PddCategoryListEntity:
			return pddCategoryListEntityToJson(data as PddCategoryListEntity);			case PddCategoryListData:
			return pddCategoryListDataToJson(data as PddCategoryListData);			case VersionInfoEntity:
			...
			return addressInfoDataToJson(data as AddressInfoData);			case LogisticsInfoEntity:
			...
			return logisticsInfoDataExpressInfoToJson(data as LogisticsInfoDataExpressInfo);			case PhoneChargeListEntity:
			...
			return pddHomeDataAdToJson(data as PddHomeDataAd);			case TaskOtherSubmitInfoEntity:
			return taskOtherSubmitInfoEntityToJson(data as TaskOtherSubmitInfoEntity);			case TaskOtherSubmitInfoData:
			return taskOtherSubmitInfoDataToJson(data as TaskOtherSubmitInfoData);			case HomePddCategoryEntity:
			...
			return homePddCategoryDataCatToJson(data as HomePddCategoryDataCat);			case GoodsSpecInfoEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'FansTotalEntity':
			...
			return FansTotalDataCountInfo().fromJson(json);			case 'PayCouponEntity':
			...
			return TaskShareDataFooterImg().fromJson(json);			case 'MicroShareholderItemEntity':
			...
			return MicroShareholderItemInterests().fromJson(json);			case 'SearchGoodsListEntity':
			...
			return SearchGoodsListDataList().fromJson(json);			case 'WithdrawalInfoEntity':
			...
			return GoodsQueuePersionalData().fromJson(json);			case 'PddGoodsInfoEntity':
			...
			return PddGoodsInfoDataCoupons().fromJson(json);			case 'CategoryBeanEntity':
			return CategoryBeanEntity().fromJson(json);			case 'CategoryBeanData':
			return CategoryBeanData().fromJson(json);			case 'TaskSubmitInfoEntity':
			return TaskSubmitInfoEntity().fromJson(json);			case 'TaskSubmitInfoData':
			return TaskSubmitInfoData().fromJson(json);			case 'OrderListEntity':
			...
			return OrderListDataListGoodsList().fromJson(json);			case 'PosterEntity':
			return PosterEntity().fromJson(json);			case 'PosterData':
			return PosterData().fromJson(json);			case 'PddGoodsListEntity':
			...
			return PddGoodsListDataListCoupons().fromJson(json);			case 'RechargeEntity':
			...
			return RechargeDatacouponList().fromJson(json);			case 'SearchPddGoodsListEntity':
			...
			return SearchPddGoodsListDataListCoupons().fromJson(json);			case 'GoodsQueueEntity':
			...
			return MicroShareholderData().fromJson(json);			case 'ShareholderIncomeListEntity':
			return ShareholderIncomeListEntity().fromJson(json);			case 'ResultBeanEntity':
			...
			return HomeIconListIconList().fromJson(json);			case 'OrderDetailEntity':
			...
			return OrderUserInfoUserInfo().fromJson(json);			case 'UserHolderProfitEntity':
			return UserHolderProfitEntity().fromJson(json);			case 'UserHolderProfitPartnerBonus':
			return UserHolderProfitPartnerBonus().fromJson(json);			case 'HomeEntity':
			...
			return HomeDataTaskListList().fromJson(json);			case 'MessageListEntity':
			return MessageListEntity().fromJson(json);			case 'MessageListData':
			return MessageListData().fromJson(json);			case 'MessageListDataList':
			return MessageListDataList().fromJson(json);			case 'PddCategoryListEntity':
			return PddCategoryListEntity().fromJson(json);			case 'PddCategoryListData':
			return PddCategoryListData().fromJson(json);			case 'VersionInfoEntity':
			...
			return AddressInfoData().fromJson(json);			case 'LogisticsInfoEntity':
			...
			return LogisticsInfoDataExpressInfo().fromJson(json);			case 'PhoneChargeListEntity':
			...
			return PddHomeDataAd().fromJson(json);			case 'TaskOtherSubmitInfoEntity':
			return TaskOtherSubmitInfoEntity().fromJson(json);			case 'TaskOtherSubmitInfoData':
			return TaskOtherSubmitInfoData().fromJson(json);			case 'HomePddCategoryEntity':
			...
			return HomePddCategoryDataCat().fromJson(json);			case 'GoodsSpecInfoEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'FansTotalEntity':
			...
			return List<FansTotalDataCountInfo>();			case 'PayCouponEntity':
			...
			return List<TaskShareDataFooterImg>();			case 'MicroShareholderItemEntity':
			...
			return List<MicroShareholderItemInterests>();			case 'SearchGoodsListEntity':
			return List<SearchGoodsListEntity>();			case 'SearchGoodsListData':
			return List<SearchGoodsListData>();			case 'SearchGoodsListDataList':
			return List<SearchGoodsListDataList>();			case 'WithdrawalInfoEntity':
			...
			return List<GoodsQueuePersionalData>();			case 'PddGoodsInfoEntity':
			return List<PddGoodsInfoEntity>();			case 'PddGoodsInfoData':
			return List<PddGoodsInfoData>();			case 'PddGoodsInfoDataCoupons':
			return List<PddGoodsInfoDataCoupons>();			case 'CategoryBeanEntity':
			return List<CategoryBeanEntity>();			case 'CategoryBeanData':
			return List<CategoryBeanData>();			case 'TaskSubmitInfoEntity':
			return List<TaskSubmitInfoEntity>();			case 'TaskSubmitInfoData':
			return List<TaskSubmitInfoData>();			case 'OrderListEntity':
			...
			return List<OrderListDataListGoodsList>();			case 'PosterEntity':
			return List<PosterEntity>();			case 'PosterData':
			return List<PosterData>();			case 'PddGoodsListEntity':
			...
			return List<PddGoodsListDataListCoupons>();			case 'RechargeEntity':
			...
			return List<RechargeDatacouponList>();			case 'SearchPddGoodsListEntity':
			...
			return List<SearchPddGoodsListDataListCoupons>();			case 'GoodsQueueEntity':
			...
			return List<MicroShareholderData>();			case 'ShareholderIncomeListEntity':
			return List<ShareholderIncomeListEntity>();			case 'ResultBeanEntity':
			return List<ResultBeanEntity>();			case 'HomeIconListEntity':
			return List<HomeIconListEntity>();			case 'HomeIconListIconList':
			return List<HomeIconListIconList>();			case 'OrderDetailEntity':
			...
			return List<OrderUserInfoUserInfo>();			case 'UserHolderProfitEntity':
			return List<UserHolderProfitEntity>();			case 'UserHolderProfitPartnerBonus':
			return List<UserHolderProfitPartnerBonus>();			case 'HomeEntity':
			...
			return List<HomeDataTaskListList>();			case 'MessageListEntity':
			return List<MessageListEntity>();			case 'MessageListData':
			return List<MessageListData>();			case 'MessageListDataList':
			return List<MessageListDataList>();			case 'PddCategoryListEntity':
			return List<PddCategoryListEntity>();			case 'PddCategoryListData':
			return List<PddCategoryListData>();			case 'VersionInfoEntity':
			...
			return List<AddressInfoData>();			case 'LogisticsInfoEntity':
			...
			return List<LogisticsInfoDataExpressInfo>();			case 'PhoneChargeListEntity':
