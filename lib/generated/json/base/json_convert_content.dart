...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case VipPriceInfoEntity:
			...
			return vipPriceInfoDiamondMoneyListFromJson(data as VipPriceInfoDiamondMoneyList, json) as T;			case GoodsInfoEntity:
			return goodsInfoEntityFromJson(data as GoodsInfoEntity, json) as T;			case GoodsInfoData:
			return goodsInfoDataFromJson(data as GoodsInfoData, json) as T;			case TaskDetailOtherEntity:
			...
			return taskDetailOtherDataDescJsonFromJson(data as TaskDetailOtherDataDescJson, json) as T;			case OrderUserInfoEntity:
			return orderUserInfoEntityFromJson(data as OrderUserInfoEntity, json) as T;			case OrderUserInfoUserInfo:
			return orderUserInfoUserInfoFromJson(data as OrderUserInfoUserInfo, json) as T;			case LogisticsInfoEntity:
			...
			return logisticsInfoDataExpressInfoFromJson(data as LogisticsInfoDataExpressInfo, json) as T;			case HomeIconListEntity:
			return homeIconListEntityFromJson(data as HomeIconListEntity, json) as T;			case HomeIconListIconList:
			return homeIconListIconListFromJson(data as HomeIconListIconList, json) as T;			case LoginEntity:
			...
			return rechargeDatacouponListFromJson(data as RechargeDatacouponList, json) as T;			case GoodsQueuePersionalEntity:
			return goodsQueuePersionalEntityFromJson(data as GoodsQueuePersionalEntity, json) as T;			case GoodsQueuePersionalData:
			return goodsQueuePersionalDataFromJson(data as GoodsQueuePersionalData, json) as T;			case BalancePayInfoEntity:
			return balancePayInfoEntityFromJson(data as BalancePayInfoEntity, json) as T;			case BalancePayInfoData:
			return balancePayInfoDataFromJson(data as BalancePayInfoData, json) as T;			case RegionDataEntity:
			...
			return regionDataDatachildchildFromJson(data as RegionDataDatachildchild, json) as T;			case TaskShareEntity:
			...
			return taskShareDataFooterImgFromJson(data as TaskShareDataFooterImg, json) as T;			case OrderDetailEntity:
			...
			return orderDetailDataGoodsListFromJson(data as OrderDetailDataGoodsList, json) as T;			case HomeGoodsListEntity:
			return homeGoodsListEntityFromJson(data as HomeGoodsListEntity, json) as T;			case HomeGoodsListGoodsList:
			return homeGoodsListGoodsListFromJson(data as HomeGoodsListGoodsList, json) as T;			case AlipayPayinfoEntity:
			...
			return taskOtherSubmitInfoDataFromJson(data as TaskOtherSubmitInfoData, json) as T;			case TaskRecordListEntity:
			...
			return taskRecordListDataListFromJson(data as TaskRecordListDataList, json) as T;			case GoodsQueueEntity:
			...
			return goodsQueueDataUserInfoFromJson(data as GoodsQueueDataUserInfo, json) as T;			case FansListEntity:
			...
			return addressInfoDataFromJson(data as AddressInfoData, json) as T;			case WithdrawalListEntity:
			...
			return wechatPayinfoDataPayInfoFromJson(data as WechatPayinfoDataPayInfo, json) as T;			case WithdrawalInfoEntity:
			...
			return withdrawalInfoDataUseModelFromJson(data as WithdrawalInfoDataUseModel, json) as T;			case PosterEntity:
			return posterEntityFromJson(data as PosterEntity, json) as T;			case PosterData:
			return posterDataFromJson(data as PosterData, json) as T;			case OrderListEntity:
			...
			return orderListDataListGoodsListFromJson(data as OrderListDataListGoodsList, json) as T;			case GoodsSpecInfoEntity:
			...
			return goodsSpecInfoSpecInfoSpecPriceIds11FromJson(data as GoodsSpecInfoSpecInfoSpecPriceIds11, json) as T;			case VipPriceEntity:
			return vipPriceEntityFromJson(data as VipPriceEntity, json) as T;			case VipPriceData:
			return vipPriceDataFromJson(data as VipPriceData, json) as T;			case WithdrawalUserInfoEntity:
			...
			return withdrawalUserInfoDataUserFromJson(data as WithdrawalUserInfoDataUser, json) as T;    }
    return data as T;
  }
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case VipPriceInfoEntity:
			...
			return vipPriceInfoDiamondMoneyListToJson(data as VipPriceInfoDiamondMoneyList);			case GoodsInfoEntity:
			return goodsInfoEntityToJson(data as GoodsInfoEntity);			case GoodsInfoData:
			return goodsInfoDataToJson(data as GoodsInfoData);			case TaskDetailOtherEntity:
			...
			return taskDetailOtherDataDescJsonToJson(data as TaskDetailOtherDataDescJson);			case OrderUserInfoEntity:
			return orderUserInfoEntityToJson(data as OrderUserInfoEntity);			case OrderUserInfoUserInfo:
			return orderUserInfoUserInfoToJson(data as OrderUserInfoUserInfo);			case LogisticsInfoEntity:
			...
			return logisticsInfoDataExpressInfoToJson(data as LogisticsInfoDataExpressInfo);			case HomeIconListEntity:
			return homeIconListEntityToJson(data as HomeIconListEntity);			case HomeIconListIconList:
			return homeIconListIconListToJson(data as HomeIconListIconList);			case LoginEntity:
			...
			return rechargeDatacouponListToJson(data as RechargeDatacouponList);			case GoodsQueuePersionalEntity:
			return goodsQueuePersionalEntityToJson(data as GoodsQueuePersionalEntity);			case GoodsQueuePersionalData:
			return goodsQueuePersionalDataToJson(data as GoodsQueuePersionalData);			case BalancePayInfoEntity:
			return balancePayInfoEntityToJson(data as BalancePayInfoEntity);			case BalancePayInfoData:
			return balancePayInfoDataToJson(data as BalancePayInfoData);			case RegionDataEntity:
			...
			return regionDataDatachildchildToJson(data as RegionDataDatachildchild);			case TaskShareEntity:
			...
			return taskShareDataFooterImgToJson(data as TaskShareDataFooterImg);			case OrderDetailEntity:
			...
			return orderDetailDataGoodsListToJson(data as OrderDetailDataGoodsList);			case HomeGoodsListEntity:
			return homeGoodsListEntityToJson(data as HomeGoodsListEntity);			case HomeGoodsListGoodsList:
			return homeGoodsListGoodsListToJson(data as HomeGoodsListGoodsList);			case AlipayPayinfoEntity:
			...
			return taskOtherSubmitInfoDataToJson(data as TaskOtherSubmitInfoData);			case TaskRecordListEntity:
			...
			return taskRecordListDataListToJson(data as TaskRecordListDataList);			case GoodsQueueEntity:
			...
			return goodsQueueDataUserInfoToJson(data as GoodsQueueDataUserInfo);			case FansListEntity:
			...
			return addressInfoDataToJson(data as AddressInfoData);			case WithdrawalListEntity:
			...
			return wechatPayinfoDataPayInfoToJson(data as WechatPayinfoDataPayInfo);			case WithdrawalInfoEntity:
			...
			return withdrawalInfoDataUseModelToJson(data as WithdrawalInfoDataUseModel);			case PosterEntity:
			return posterEntityToJson(data as PosterEntity);			case PosterData:
			return posterDataToJson(data as PosterData);			case OrderListEntity:
			...
			return orderListDataListGoodsListToJson(data as OrderListDataListGoodsList);			case GoodsSpecInfoEntity:
			...
			return goodsSpecInfoSpecInfoSpecPriceIds11ToJson(data as GoodsSpecInfoSpecInfoSpecPriceIds11);			case VipPriceEntity:
			return vipPriceEntityToJson(data as VipPriceEntity);			case VipPriceData:
			return vipPriceDataToJson(data as VipPriceData);			case WithdrawalUserInfoEntity:
			...
			return withdrawalUserInfoDataUserToJson(data as WithdrawalUserInfoDataUser);    }
    return data as T;
  }
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'VipPriceInfoEntity':
			...
			return VipPriceInfoDiamondMoneyList().fromJson(json);			case 'GoodsInfoEntity':
			return GoodsInfoEntity().fromJson(json);			case 'GoodsInfoData':
			return GoodsInfoData().fromJson(json);			case 'TaskDetailOtherEntity':
			...
			return TaskDetailOtherDataDescJson().fromJson(json);			case 'OrderUserInfoEntity':
			return OrderUserInfoEntity().fromJson(json);			case 'OrderUserInfoUserInfo':
			return OrderUserInfoUserInfo().fromJson(json);			case 'LogisticsInfoEntity':
			...
			return LogisticsInfoDataExpressInfo().fromJson(json);			case 'HomeIconListEntity':
			return HomeIconListEntity().fromJson(json);			case 'HomeIconListIconList':
			return HomeIconListIconList().fromJson(json);			case 'LoginEntity':
			...
			return RechargeDatacouponList().fromJson(json);			case 'GoodsQueuePersionalEntity':
			return GoodsQueuePersionalEntity().fromJson(json);			case 'GoodsQueuePersionalData':
			return GoodsQueuePersionalData().fromJson(json);			case 'BalancePayInfoEntity':
			return BalancePayInfoEntity().fromJson(json);			case 'BalancePayInfoData':
			return BalancePayInfoData().fromJson(json);			case 'RegionDataEntity':
			...
			return RegionDataDatachildchild().fromJson(json);			case 'TaskShareEntity':
			...
			return TaskShareDataFooterImg().fromJson(json);			case 'OrderDetailEntity':
			...
			return OrderDetailDataGoodsList().fromJson(json);			case 'HomeGoodsListEntity':
			return HomeGoodsListEntity().fromJson(json);			case 'HomeGoodsListGoodsList':
			return HomeGoodsListGoodsList().fromJson(json);			case 'AlipayPayinfoEntity':
			...
			return TaskOtherSubmitInfoData().fromJson(json);			case 'TaskRecordListEntity':
			...
			return TaskRecordListDataList().fromJson(json);			case 'GoodsQueueEntity':
			...
			return GoodsQueueDataUserInfo().fromJson(json);			case 'FansListEntity':
			...
			return AddressInfoData().fromJson(json);			case 'WithdrawalListEntity':
			...
			return WechatPayinfoDataPayInfo().fromJson(json);			case 'WithdrawalInfoEntity':
			...
			return WithdrawalInfoDataUseModel().fromJson(json);			case 'PosterEntity':
			return PosterEntity().fromJson(json);			case 'PosterData':
			return PosterData().fromJson(json);			case 'OrderListEntity':
			...
			return OrderListDataListGoodsList().fromJson(json);			case 'GoodsSpecInfoEntity':
			...
			return GoodsSpecInfoSpecInfoSpecPriceIds11().fromJson(json);			case 'VipPriceEntity':
			return VipPriceEntity().fromJson(json);			case 'VipPriceData':
			return VipPriceData().fromJson(json);			case 'WithdrawalUserInfoEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'VipPriceInfoEntity':
			...
			return List<VipPriceInfoDiamondMoneyList>();			case 'GoodsInfoEntity':
			return List<GoodsInfoEntity>();			case 'GoodsInfoData':
			return List<GoodsInfoData>();			case 'TaskDetailOtherEntity':
			...
			return List<TaskDetailOtherDataDescJson>();			case 'OrderUserInfoEntity':
			return List<OrderUserInfoEntity>();			case 'OrderUserInfoUserInfo':
			return List<OrderUserInfoUserInfo>();			case 'LogisticsInfoEntity':
			...
			return List<LogisticsInfoDataExpressInfo>();			case 'HomeIconListEntity':
			return List<HomeIconListEntity>();			case 'HomeIconListIconList':
			return List<HomeIconListIconList>();			case 'LoginEntity':
			...
			return List<RechargeDatacouponList>();			case 'GoodsQueuePersionalEntity':
			return List<GoodsQueuePersionalEntity>();			case 'GoodsQueuePersionalData':
			return List<GoodsQueuePersionalData>();			case 'BalancePayInfoEntity':
			return List<BalancePayInfoEntity>();			case 'BalancePayInfoData':
			return List<BalancePayInfoData>();			case 'RegionDataEntity':
			...
			return List<RegionDataDatachildchild>();			case 'TaskShareEntity':
			...
			return List<TaskShareDataFooterImg>();			case 'OrderDetailEntity':
			return List<OrderDetailEntity>();			case 'OrderDetailData':
			return List<OrderDetailData>();			case 'OrderDetailDataGoodsList':
			return List<OrderDetailDataGoodsList>();			case 'HomeGoodsListEntity':
			return List<HomeGoodsListEntity>();			case 'HomeGoodsListGoodsList':
			return List<HomeGoodsListGoodsList>();			case 'AlipayPayinfoEntity':
			...
			return List<TaskOtherSubmitInfoData>();			case 'TaskRecordListEntity':
			return List<TaskRecordListEntity>();			case 'TaskRecordListData':
			return List<TaskRecordListData>();			case 'TaskRecordListDataList':
			return List<TaskRecordListDataList>();			case 'GoodsQueueEntity':
			...
			return List<GoodsQueueDataUserInfo>();			case 'FansListEntity':
			...
			return List<AddressInfoData>();			case 'WithdrawalListEntity':
			...
			return List<WechatPayinfoDataPayInfo>();			case 'WithdrawalInfoEntity':
			...
			return List<WithdrawalInfoDataUseModel>();			case 'PosterEntity':
			return List<PosterEntity>();			case 'PosterData':
			return List<PosterData>();			case 'OrderListEntity':
			...
			return List<OrderListDataListGoodsList>();			case 'GoodsSpecInfoEntity':
			...
			return List<GoodsSpecInfoSpecInfoSpecPriceIds11>();			case 'VipPriceEntity':
			return List<VipPriceEntity>();			case 'VipPriceData':
			return List<VipPriceData>();			case 'WithdrawalUserInfoEntity':
