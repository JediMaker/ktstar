...
orderDetailDataGoodsListFromJson(
    OrderDetailDataGoodsList data, Map<String, dynamic> json) {
...
Map<String, dynamic> orderDetailDataGoodsListToJson(
    OrderDetailDataGoodsList entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
