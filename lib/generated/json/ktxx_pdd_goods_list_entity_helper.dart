...
pddGoodsListDataListFromJson(
    PddGoodsListDataList data, Map<String, dynamic> json) {
  if (json['g_id'] != null) {
  ...
  if (json['coupons'] != null) {
    try {
      data.coupons =
          new PddGoodsListDataListCoupons().fromJson(json['coupons']);
    } catch (e) {}
  }
  return data;
}
...
pddGoodsListDataListCouponsFromJson(
    PddGoodsListDataListCoupons data, Map<String, dynamic> json) {
...
Map<String, dynamic> pddGoodsListDataListCouponsToJson(
    PddGoodsListDataListCoupons entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
