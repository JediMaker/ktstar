...
homePddCategoryDataFromJson(HomePddCategoryData data, Map<String, dynamic> json) {
	if (json['cats'] != null) {
...
homePddCategoryDataCatFromJson(HomePddCategoryDataCat data, Map<String, dynamic> json) {
	if (json['cat_id'] != null) {
...
Map<String, dynamic> homePddCategoryDataCatToJson(HomePddCategoryDataCat entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
