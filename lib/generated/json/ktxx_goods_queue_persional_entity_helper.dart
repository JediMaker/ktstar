...
goodsQueuePersionalEntityFromJson(
    GoodsQueuePersionalEntity data, Map<String, dynamic> json) {
  if (json['status'] != null) {
...
Map<String, dynamic> goodsQueuePersionalEntityToJson(
    GoodsQueuePersionalEntity entity) {
...
goodsQueuePersionalDataFromJson(
    GoodsQueuePersionalData data, Map<String, dynamic> json) {
...
Map<String, dynamic> goodsQueuePersionalDataToJson(
    GoodsQueuePersionalData entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
