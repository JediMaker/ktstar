...
goodsQueuePersionalEntityFromJson(KeTaoFeaturedGoodsQueuePersionalEntity data, Map<String, dynamic> json) {
	if (json['status'] != null) {
	...
	if (json['data'] != null) {
		data.data = new List<KeTaoFeaturedGoodsQueuePersionalData>();
		(json['data'] as List).forEach((v) {
			try {
				data.data.add(new KeTaoFeaturedGoodsQueuePersionalData().fromJson(v));
			} catch (e) {
			}
		});
	}
...
Map<String, dynamic> goodsQueuePersionalEntityToJson(KeTaoFeaturedGoodsQueuePersionalEntity entity) {
...
goodsQueuePersionalDataFromJson(KeTaoFeaturedGoodsQueuePersionalData data, Map<String, dynamic> json) {
...
Map<String, dynamic> goodsQueuePersionalDataToJson(KeTaoFeaturedGoodsQueuePersionalData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
