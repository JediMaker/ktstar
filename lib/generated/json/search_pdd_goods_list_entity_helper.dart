...
Map<String, dynamic> searchPddGoodsListEntityToJson(SearchPddGoodsListEntity entity) {
...
searchPddGoodsListDataFromJson(SearchPddGoodsListData data, Map<String, dynamic> json) {
	if (json['total'] != null) {
...
Map<String, dynamic> searchPddGoodsListDataToJson(SearchPddGoodsListData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
searchPddGoodsListDataListFromJson(SearchPddGoodsListDataList data, Map<String, dynamic> json) {
	if (json['g_id'] != null) {
...
Map<String, dynamic> searchPddGoodsListDataListToJson(SearchPddGoodsListDataList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
searchPddGoodsListDataListCouponsFromJson(SearchPddGoodsListDataListCoupons data, Map<String, dynamic> json) {
...
Map<String, dynamic> searchPddGoodsListDataListCouponsToJson(SearchPddGoodsListDataListCoupons entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
