...
microShareholderEntityFromJson(
    MicroShareholderEntity data, Map<String, dynamic> json) {
  if (json['status'] != null) {
...
Map<String, dynamic> microShareholderEntityToJson(
    MicroShareholderEntity entity) {
...
microShareholderDataFromJson(
    MicroShareholderData data, Map<String, dynamic> json) {
  if (json['grade1'] != null) {
