...
/*------------------地址相关END-------------------*/
  ...
  static const String AUTHORIZE =
      "/api/index.php?route=oauth/oauth2/authorize"; ///获取授权码
  static const String AUTHORIZE2 =
      "api/index.php?route=oauth/oauth2/authorize"; ///获取授权码
  static const String ACCESS_TOKEN =
      "/api/index.php?route=oauth/oauth2/token"; ///获取令牌access_token
  static const String ACCESS_TOKEN2 =
      "api/index.php?route=oauth/oauth2/token"; ///获取令牌access_token
  static const String REFRESH_TOKEN =
      "/api/index.php?route=oauth/oauth2/refresh_token"; ///刷新令牌
  static const String REFRESH_TOKEN2 =
      "api/index.php?route=oauth/oauth2/refresh_token"; ///刷新令牌

  static const String HOME = "/api/index.php?route=api/home"; ///首页
  static const String HOME_PRODUCTS_LIST =
      "/api/index.php?route=api/home/getProductList"; ///首页最新商品列表
  static const String HOME_HotProducts_LIST =
      "/api/index.php?route=api/home/getProductHotList"; ///首页热门商品列表
  static const String HOME_SEARCH_PRODUCTS_LIST =
      "/api/index.php?route=api/search"; ///首页搜索商品列表
  static const String CATEGORY_GOODS_LIST =
      "/api/index.php?route=api/category/goods"; ///首页分类商品列表
  static const String CATEGORY = "/api/index.php?route=api/category"; ///分类

  ///购物车
  static const String CART = "/api/index.php?route=api/cart";///添加商品
  static const String CART_ADD = "/api/index.php?route=api/cart/add";  ///删除商品
  static const String CART_DEL = "/api/index.php?route=api/cart/remove";///修改商品
...
///协议信息地址
  ...
  static const String AGREEMENT_REGISTRATION_URL =
      "http:///mxss.bainianmao.com/doc/zhuce.html";
  ///用户服务协议
  static const String AGREEMENT_SERVICES_URL =
      "http:///mxss.bainianmao.com/doc/tiaokuan.html";
  ///用户隐私协议
  static const String AGREEMENT_PRIVACY_URL =
      "http:///mxss.bainianmao.com/doc/yinsi.html";
///商品详情
  static const String PRODUCT = "/api/index.php?route=api/product";

///订单相关
  static const String ORDER_CHECKOUT =
      "/api/index.php?route=api/checkout"; ///提交订单
  static const String ORDER_CHECKOUT_CONFIRM =
      "/api/index.php?route=api/checkout/confirm"; ///确定提交
  static const String ORDER_DETAIL = "/api/index.php?route=api/order"; ///订单详情
  static const String ORDER_HISTORY =
      "/api/index.php?route=api/order/history"; ///历史订单
  static const String ORDER_STATUS =
      "/api/index.php?route=api/order/status"; ///各个状态订单
  static const String ORDER_DEL = "/api/index.php?route=api/order/del"; ///订单删除
  static const String ORDER_CHECKOUTXX =
      "/api/index.php?route=api/checkout/checkout"; ///订单列表页面去支付调用
