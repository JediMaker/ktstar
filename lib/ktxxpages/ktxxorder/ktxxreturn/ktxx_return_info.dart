...
//List<Asset> images2 = List<Asset>();
  ...
  void initState() {
    ...
    switch (_returnOrderStatus) {
      case _KeTaoFeaturedReturnInfoPageState._STATUS_WAIT: //待处理
        _requestDesc = '平台会在7个工作日内给您答复，如有疑问请咨询客服。';
        _requestDescTitle = '请等待平台处理';

        break;
      case _KeTaoFeaturedReturnInfoPageState._STATUS_AGREE_TO_RETURN: //同意退货
        _requestDesc = '请先咨询客服退货地址，并请记录退货运单号。';
        _requestDescTitle = '已同意退货申请';
        break;
      case _KeTaoFeaturedReturnInfoPageState._STATUS_AGREE_TO_EXCHANGE: //同意换货
        _requestDesc = '请先咨询客服退货地址，并请记录退货运单号。';
        _requestDescTitle = '已同意换货申请';
        break;
      case _KeTaoFeaturedReturnInfoPageState._STATUS_SUCCESSFUL_RETURN: //退货成功
      ...
      case _KeTaoFeaturedReturnInfoPageState._STATUS_SUCCESSFUL_REPLACEMENT: //换货成功
        ...
        _isReturnSuccess = true;
        break;
      case _KeTaoFeaturedReturnInfoPageState._STATUS_REFUND_SUCCESSFULLY: //退款成功
        _requestDesc = '2020年12月01日  17:39';
        _requestDescTitle = '退款成功';
        _isReturnSuccess = true;
        break;
  ...
  Widget buildReturnSuccessfulContainer() {
    return Visibility(
        visible: _returnOrderStatus ==
            _KeTaoFeaturedReturnInfoPageState._STATUS_SUCCESSFUL_RETURN,
        child: Container(
            width: double.infinity,
            color: Colors.white,
            padding: EdgeInsets.symmetric(
