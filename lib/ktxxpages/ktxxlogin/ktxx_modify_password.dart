...
class KeTaoFeaturedModifyPasswordPage extends StatefulWidget {
  ...
  @override
  _KeTaoFeaturedModifyPasswordPageState createState() => _KeTaoFeaturedModifyPasswordPageState();
}
// Copyright (c) 2021, the Dart project authors.  Please see the AUTHORS file
// for details. All rights reserved. Use of this source code is governed by a
// BSD-style license that can be found in the LICENSE file.
class _KeTaoFeaturedModifyPasswordPageState extends State<KeTaoFeaturedModifyPasswordPage>
...
*/
                  ...
                  child: InkWell(
                      onTap: () async {
                        if (_phoneController.value.text == null ||
                          ...
                          var result = await KeTaoFeaturedHttpManage.modifyPassword(
  ...
  Future<bool> smsSend(BuildContext context) async {
    if (KeTaoFeaturedCommonUtils.isPhoneLegal(_phoneController.value.text)) {
      var result = await KeTaoFeaturedHttpManage.sendVerificationCode(
