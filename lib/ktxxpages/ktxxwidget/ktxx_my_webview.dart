...
import 'ktxx_loading_nomal.dart';
...
class KeTaoFeaturedWebViewPage extends StatefulWidget {
  ...
  @override
  _KeTaoFeaturedWebViewPageState createState() => _KeTaoFeaturedWebViewPageState();
}

class _KeTaoFeaturedWebViewPageState extends State<KeTaoFeaturedWebViewPage> {
...
//                  print('Page started loading: $url');
                setState(() {
                  _loadingVisiablity = true;
                });
              },
              onPageFinished: (String url) {
//                  print('Page finished loading: $url');
                setState(() {
                  _loadingVisiablity = false;
                });
              },
