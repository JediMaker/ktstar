...
class KeTaoFeaturedTaskSharePage extends StatefulWidget {
  ...
  @override
  _KeTaoFeaturedTaskSharePageState createState() => _KeTaoFeaturedTaskSharePageState();
}//    Container(
//height: 6.0,
//width: 6.0,
...
// for details. All rights reserved. Use of this source code is governed by a
// BSD-style license that can be found in the LICENSE file.
class _KeTaoFeaturedTaskSharePageState extends State<KeTaoFeaturedTaskSharePage> {
...
//      'https://s4-cs-pub-std.oss-cn-hangzhou.aliyuncs.com/im_plugin_button_image/tid552/kefu_1599649701199_j2rmr.png';
  ...
  _initData() async {
    var result = await KeTaoFeaturedHttpManage.getTaskDetailWechat(widget.taskId);
    if (result.status) {
      if (mounted) {
        setState(() {
          try {
