...
import 'package:star/ktxxpages/ktxxtask/ktxx_task_detail.dart';
import 'package:flutter_page_indicator/flutter_page_indicator.dart';
import 'package:star/ktxxpages/ktxxtask/ktxx_task_detail_other.dart';
...
import 'package:star/ktxxpages/ktxxtask/ktxx_task_share.dart';
              ...
              Expanded(
                child: Column(
                  children: [
                    ...
                    Visibility(
                      visible: !KeTaoFeaturedCommonUtils.isEmpty("${classify.subtitle}"),
                      child: Container(
...
//      print("iconsubtitle=${icon + name + type + appId + path + subtitle}");
    ...
    if (Platform.isIOS) {
      isUnderReview = KeTaoFeaturedGlobalConfig.prefs.getBool("isHuaweiUnderReview");
    }
