...
class KTKJShopPaymentPage extends StatefulWidget {
  var orderId;
...
// for details. All rights reserved. Use of this source code is governed by a
// BSD-style license that can be found in the LICENSE file.
class _ShopPaymentPageState extends State<KTKJShopPaymentPage> {
  var _latitude;
  var _longitude;
                        ...
                        Visibility(
                          ...
                          child: Opacity(
                            ...
                            child: ListTile(
                              onTap: () async {
                                if (!_canUseBalance) {
                                  KTKJCommonUtils.showToast("账户余额不足！");
                                  return;
                                }
                                setState(() {
                                  _payWay = 3;
        ...
        child: TextField(
          ...
          onChanged: (value) {
            setState(() {
              ...
              if (KTKJCommonUtils.isEmpty(_payAmount)) {
                return;
              }
              try {
                if (mounted) {
    ...
    return Container(
      ...
      child: Ink(
        child: InkWell(
            onTap: () async {
              if (KTKJCommonUtils.isEmpty(_payAmount)) {
                KTKJCommonUtils.showToast("请输入消费金额");
                return;
              }
              switch (_payWay) {
                case 1:
